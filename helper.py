import os, json, numpy as np, random, torch, transformers, functools, time, csv, string, re
...
def clean_text(text):
    text = text.replace('Coherence Relation:', '')
    text = text.replace('Coherence Relations:', '')
